...
ClassName	Db	"mx.class",0
ClassIDString	Db	"mx.class 1.0 (2001-12-05)",0
...
;-   -  - -- ---=--=-==-===-====-==============-====-===-==-=--=--- -- -  -   -
	%Include	"MX\MX_AddMember.S"
	%Include	"MX\MX_Create.s"
	%Include	"MX\MX_Event.S"
	%Include	"MX\MX_GetAttributes.S"
	%Include	"MX\MX_GetMetrics.S"
	%Include	"MX\MX_Layout.S"
	%Include	"MX\MX_Refresh.S"
	%Include	"MX\MX_RemMember.S"
	%Include	"MX\MX_Remove.S"
	%Include	"MX\MX_Render.S"
	%Include	"MX\MX_SetAttributes.S"
