...
;
	...
	%Include	"..\Includes\Classes\Tree.I"
...
ClassName	Db	"tree.class",0
ClassIDString	Db	"tree.class 1.0 (2001-12-05)",0
...
;-   -  - -- ---=--=-==-===-====-==============-====-===-==-=--=--- -- -  -   -
	%Include	"Tree\Tree_AddMember.S"
	%Include	"Tree\Tree_Create.s"
	%Include	"Tree\Tree_Event.S"
	%Include	"Tree\Tree_GetAttributes.S"
	%Include	"Tree\Tree_GetMetrics.S"
	%Include	"Tree\Tree_Layout.S"
	%Include	"Tree\Tree_Refresh.S"
	%Include	"Tree\Tree_RemMember.S"
	%Include	"Tree\Tree_Remove.S"
	%Include	"Tree\Tree_Render.S"
	%Include	"Tree\Tree_SetAttributes.S"
