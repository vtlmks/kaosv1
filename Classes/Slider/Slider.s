...
;
	...
	%Include	"..\Includes\Classes\Slider.I"
...
ClassName	Db	"slider.class",0
ClassIDString	Db	"slider.class 1.0 (2001-12-05)",0
...
;-   -  - -- ---=--=-==-===-====-==============-====-===-==-=--=--- -- -  -   -
	%Include	"Slider\Slider_AddMember.S"
	%Include	"Slider\Slider_Create.s"
	%Include	"Slider\Slider_Event.S"
	%Include	"Slider\Slider_GetAttributes.S"
	%Include	"Slider\Slider_GetMetrics.S"
	%Include	"Slider\Slider_Layout.S"
	%Include	"Slider\Slider_Refresh.S"
	%Include	"Slider\Slider_RemMember.S"
	%Include	"Slider\Slider_Remove.S"
	%Include	"Slider\Slider_Render.S"
	%Include	"Slider\Slider_SetAttributes.S"
