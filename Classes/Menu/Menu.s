...
;
	...
	%Include	"..\Includes\Classes\Menu.I"
...
ClassName	Db	"menu.class",0
ClassIDString	Db	"menu.class 1.0 (2001-12-05)",0
...
;-   -  - -- ---=--=-==-===-====-==============-====-===-==-=--=--- -- -  -   -
	%Include	"Menu\Menu_AddMember.S"
	%Include	"Menu\Menu_Create.s"
	%Include	"Menu\Menu_Event.S"
	%Include	"Menu\Menu_GetAttributes.S"
	%Include	"Menu\Menu_GetMetrics.S"
	%Include	"Menu\Menu_Layout.S"
	%Include	"Menu\Menu_Refresh.S"
	%Include	"Menu\Menu_RemMember.S"
	%Include	"Menu\Menu_Remove.S"
	%Include	"Menu\Menu_Render.S"
	%Include	"Menu\Menu_SetAttributes.S"
