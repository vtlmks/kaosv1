...
;
	...
	%Include	"..\Includes\Classes\Cycle.I"
...
ClassName	Db	"cycle.class",0
ClassIDString	Db	"cycle.class 1.0 (2001-12-05)",0
...
;-   -  - -- ---=--=-==-===-====-==============-====-===-==-=--=--- -- -  -   -
	%Include	"Cycle\Cycle_AddMember.S"
	%Include	"Cycle\Cycle_Create.s"
	%Include	"Cycle\Cycle_Event.S"
	%Include	"Cycle\Cycle_GetAttributes.S"
	%Include	"Cycle\Cycle_GetMetrics.S"
	%Include	"Cycle\Cycle_Layout.S"
	%Include	"Cycle\Cycle_Refresh.S"
	%Include	"Cycle\Cycle_RemMember.S"
	%Include	"Cycle\Cycle_Remove.S"
	%Include	"Cycle\Cycle_Render.S"
	%Include	"Cycle\Cycle_SetAttributes.S"
