...
;
	...
	%Include	"..\Includes\Classes\String.I"
...
ClassName	Db	"string.class",0
ClassIDString	Db	"string.class 1.0 (2001-12-05)",0
...
;-   -  - -- ---=--=-==-===-====-==============-====-===-==-=--=--- -- -  -   -
	%Include	"String\String_AddMember.S"
	%Include	"String\String_Create.s"
	%Include	"String\String_Event.S"
	%Include	"String\String_GetAttributes.S"
	%Include	"String\String_GetMetrics.S"
	%Include	"String\String_Layout.S"
	%Include	"String\String_Refresh.S"
	%Include	"String\String_RemMember.S"
	%Include	"String\String_Remove.S"
	%Include	"String\String_Render.S"
	%Include	"String\String_SetAttributes.S"
