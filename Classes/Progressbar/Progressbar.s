...
;     All rights reserved.
;
;     Progressbarclass.s V1.0.0
;
;     Progressbar.class V1.0.0
;
;
...
ClassName	Db	"progressbar.class",0
ClassIDString	Db	"progressbar.class 1.0 (2001-12-05)",0
...
;-   -  - -- ---=--=-==-===-====-==============-====-===-==-=--=--- -- -  -   -
	%Include	"Progressbar\Progressbar_AddMember.S"
	%Include	"Progressbar\Progressbar_Create.s"
	%Include	"Progressbar\Progressbar_Event.S"
	%Include	"Progressbar\Progressbar_GetAttributes.S"
	%Include	"Progressbar\Progressbar_GetMetrics.S"
	%Include	"Progressbar\Progressbar_Layout.S"
	%Include	"Progressbar\Progressbar_Refresh.S"
	%Include	"Progressbar\Progressbar_RemMember.S"
	%Include	"Progressbar\Progressbar_Remove.S"
	%Include	"Progressbar\Progressbar_Render.S"
	%Include	"Progressbar\Progressbar_SetAttributes.S"
