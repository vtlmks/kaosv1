...
;	Equ	0x1c18	; Reserved
MGA_PLNWT	Equ	0x1c1c	; Plane Write Mask
...
;	Equ	0x1dd0	; Reserved (WDBR)
MGA_WACCEPTSEQ	Equ	0x1dd4	; WARP Accept Sequence
MGA_WIADDR2	Equ	0x1dd8	; WARP Instruction Address 2
;	EQU	0x1ddc	; Reserved
MGA_WFLAG1	Equ	0x1de0	; WARP Flags 1
...
MGA_WIADDRNB2	Equ	0x1e00	; WARP Instruction Address (Non Blocking) 2
MGA_WIADDRNB1	Equ	0x1e04	; WARP Instruction Address (Non Blocking) 1
MGA_WFLAGNB1	Equ	0x1e08	; WARP Flags (Non Blocking) 1
MGA_TEST1	Equ	0x1e0c	; Test 1
...
;-   -  - -- ---=--=-==-===-====-==============-====-===-==-=--=--- -- -  -   -
;
; 0x2080 -> 0x20ff = Reserved
;

;-   -  - -- ---=--=-==-===-====-==============-====-===-==-=--=--- -- -  -   -
;
; 0x2100 -> 0x217f = WIMEMDATA1 ; WARP Instruction Memory
;
MGA_WIMEMDATA1	Equ	0x2100	; WARP Instruction Memory Data


;-   -  - -- ---=--=-==-===-====-==============-====-===-==-=--=--- -- -  -   -
;
; 0x2180 -> 0x2dff = DWGREG1 ; Second Drawing Registers
;
;	Equ	0x2180 -> 0x2bfc	; Reserved
...
;	Equ	0x2cbc -> 2cc4	; Reserved
MGA_STENCIL	Equ	0x2cc8	; Stencil
MGA_STENCILCTL	Equ	0x2ccc	; Stencil Control
MGA_SETUPADDRESS Equ	0x2cd0	; Setup DMA Current Address
MGA_SETUPEND	Equ	0x2cd4	; Setup DMA End Address
;	Equ	0x2cd8 -> 0x2cec	; Reserved
MGA_TBUMPMAT	Equ	0x2cf0	; Texture Bump Map Transform
MGA_TBUMPFMT	Equ	0x2cf4	; Texture Bump Map Format
MGA_TDUALSTAGE0	Equ	0x2cf8	; Texture Dual Stage 0
MGA_TDUALSTAGE1	Equ	0x2cfc	; Texture Dual Stage 1
...
;-   -  - -- ---=--=-==-===-====-==============-====-===-==-=--=--- -- -  -   -
;
; 0x3c10 -> 0x3c58 = CRTC2 ; Second CRTC
;

MGA_C2CTL	Equ	0x3c10	; CRTC2 Control
MGA_C2HPARAM	Equ	0x3c14	; CRTC2 Horizontal Parameters
MGA_C2HSYNC	Equ	0x3c18	; CRTC2 Horizontal Sync
MGA_C2VPARAM	Equ	0x3c1c	; CRTC2 Vertical Parameters
MGA_C2VSYNC	Equ	0x3c20	; CRTC2 Vertical Sync
MGA_C2PRELOAD	Equ	0x3c24	; CRTC2 Preload Values
MGA_C2STARTADD0	Equ	0x3c28	; CRTC2 Field #0 Start Address
MGA_C2STARTADD1	Equ	0x3c2c	; CRTC2 Field #1 Start Address
MGA_C2PL2STARTADD0 Equ	0x3c30	; CRTC2 Field #0 Plane #2 Start Address
MGA_C2PL2STARTADD1 Equ	0x3c34	; CRTC2 Field #1 Plane #2 Start Address
MGA_C2PL3STARTADD0 Equ	0x3c38	; CRTC2 Field #0 Plane #3 Start Address
MGA_C2PL3STARTADD1 Equ	0x3c3c	; CRTC2 Field #1 Plane #3 Start Address
MGA_C2OFFSET	Equ	0x3c40	; CRTC2 Offset Value
MGA_C2MISC	Equ	0x3c44	; CRTC2 Miscellaneous
MGA_C2VCOUNT	Equ	0x3c48	; CRTC2 Vertical Count
MGA_C2DATACTL	Equ	0x3c4c	; CRTC2 Data Control
MGA_C2SUBPICLUT	Equ	0x3c50	; CRTC2 Sub-Picture Color LUT
MGA_C2PICSTARTADD0 Equ	0x3c54	; CRTC2 Field #0 Sub-Picture Start Address
MGA_C2PICSTARTADD1 Equ	0x3c58	; CRTC2 Field #1 Sub-Picture Start Address

;-   -  - -- ---=--=-==-===-====-==============-====-===-==-=--=--- -- -  -   -
;
; 0x3c5c -> 0x3cff = Reserved
;
...
MGA_BESLUMACTL	Equ	0x3d40	; BES Luma Control
;	Equ	0x3d44	; Reserved
...
;	Equ	0x3d5c	; Reserved
MGA_BESA1C3ORG	Equ	0x3d60	; BES Buffer A-1 Chroma 3-Plane Org.
MGA_BESA2C3ORG	Equ	0x3d64	; BES Buffer A-2 Chroma 3-Plane Org
MGA_BESB1C3ORG	Equ	0x3d68	; BES Buffer B-1 Chroma 3-Plane Org.
MGA_BESB2C3ORG	Equ	0x3d6c	; BES Buffer B-2 Chroma 3-Plane Org.
...
MGA_VINADDR2	Equ	0x3e20	; Video Input Address Window 2
MGA_VINADDR3	Equ	0x3e24	; Video Input Address Window 3
MGA_VINCTL2	Equ	0x3e28	; Video Input Control Window 2
MGA_VINCTL3	Equ	0x3e2c	; Video Input Control Window 3
...
MGA_VINHEIGHT	Equ	0x3e3c	; Video In Maximum Height
